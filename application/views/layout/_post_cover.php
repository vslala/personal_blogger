        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="post-heading">
                    <h1 class="animated fadeInDown" style="background-color: rgba(00,00,00,.5);"><?= $cover_heading; ?></h1>
                    <span style="background-color: rgba(00,00,00,.5)" class="meta animated fadeInUp"><?= $cover_subheading; ?></span>
                </div>
            </div>
        </div>
    </div>
